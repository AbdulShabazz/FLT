...
lemma borel_eq_pi_borel [Fintype ι] [∀ i, TopologicalSpace (H i)] :
  ...
  -- This equality is a standard result for finite products of topological spaces.
  exact borel_pi_eq
...
lemma pi_borel_eq_borel_pi [Fintype ι] [∀ i, TopologicalSpace (H i)] :
  ...
  -- This identity is a standard result for finite products of topological spaces,
  -- and it is proven by the `borel_pi_eq` theorem.
  exact borel_pi_eq
